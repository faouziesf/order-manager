                    ...
                    <div class="section-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control @error('customer_phone_2') is-invalid @enderror"
                                ...
                                placeholder="Téléphone alternatif (optionnel)" autocomplete="tel">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('customer_address') is-invalid @enderror" id="customer_address"
                                name="customer_address" rows="3" placeholder="Adresse détaillée du client" autocomplete="street-address">{{ old('customer_address', $order->customer_address) }}</textarea>
                        ...
                        <div class="call-attempt-form">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="attempt_notes" name="notes"
                                    placeholder="Décrivez le résultat de votre appel (répondu, occupé, boîte vocale, etc.)" required></textarea>
                            </div>
