...
<!-- Modal de chargement -->
<div id="loadingOverlay" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255,255,255,0.8); z-index: 9999; display: none; justify-content: center; align-items: center;">
...
case 's':
    ...
    function initializeOrderFormFunctionality(order) {
        ...
        $(document).off('change', '.product-select, .product-quantity').on('change', '.product-select, .product-quantity', function() {
    ...
    function loadOrderHistory() {
        ...
        timeline.innerHTML = '<div class="text-center p-3"><i class="fas fa-spinner fa-spin me-2"></i> Chargement...</div>';
        ...
        $.ajax({
            ...
            error: function() {
                timeline.innerHTML = '<div class="text-center text-danger p-3">Erreur lors du chargement de l\'historique</div>';
            }
        });
    }
    ...
    function validateForm() {
        ...
        if (action === 'confirm') {
            ...
            const requiredFields = ['customer_name', 'customer_phone', 'customer_governorate', 'customer_city', 'customer_address'];
