...
html[data-theme="dark"] .card { background: var(--bg-card, #111827) !important; border-color: var(--border, #374151) !important; }
html[data-theme="dark"] .card-header { background: var(--bg-muted, #1f2937) !important; color: var(--text, #f9fafb) !important; border-color: var(--border, #374151) !important; }
html[data-theme="dark"] .card-body { background: var(--bg-card, #111827) !important; }
html[data-theme="dark"] .btn-primary { background: linear-gradient(135deg, #d97706 0%, #b45309 100%) !important; }
