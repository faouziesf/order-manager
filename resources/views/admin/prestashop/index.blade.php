...
@section('title', 'Intégrations PrestaShop')
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fab fa-prestashop me-3"></i>Intégrations PrestaShop
    </h1>
    <div class="d-flex gap-2">
        ...
        @if($integrations->where('is_active', true)->count() > 0)
            <a href="{{ route('admin.prestashop.sync') }}" class="btn btn-primary">
                ...
                <div class="col-md-6">
                    <div class="integration-info">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h6 class="mb-0">{{ parse_url($integration->shop_url, PHP_URL_HOST) }}</h6>
                        </div>
                        <div class="integration-url">{{ $integration->shop_url }}</div>
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-3">
                        ...
                        <div class="integration-actions">
                            <button class="btn btn-sm btn-outline-danger" 
                                    onclick="deleteIntegration({{ $integration->id }}, '{{ parse_url($integration->shop_url, PHP_URL_HOST) }}')">
...
<div class="row">
    <div class="col-12">
        <div class="config-section text-center">
            <div class="mb-4">
                <i class="fab fa-prestashop display-4 text-muted mb-3"></i>
                <h4 class="text-muted">Aucune intégration PrestaShop configurée</h4>
                <p class="text-muted">Commencez par connecter votre première boutique PrestaShop</p>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addIntegrationModalLabel">
                    <i class="fab fa-prestashop me-2"></i>Nouvelle intégration PrestaShop
                </h5>
            ...
            <form action="{{ route('admin.prestashop.store') }}" method="POST" id="prestashop-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="shop_url">URL de la boutique PrestaShop</label>
                                <input type="url" class="form-control @error('shop_url') is-invalid @enderror" 
                                ...
                                @enderror
                                <small class="form-text text-muted">L'URL complète de votre boutique PrestaShop</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="api_key">Clé Web Service PrestaShop</label>
                                <input type="text" class="form-control @error('api_key') is-invalid @enderror"
                                       id="api_key" name="api_key"
                                       value="{{ old('api_key') }}"
                                       required placeholder="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX">
                                @error('api_key')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Clé générée dans les paramètres Web Service de PrestaShop</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="help-box">
                        <h6><i class="fas fa-info-circle me-2"></i>Comment obtenir votre clé API PrestaShop</h6>
                        <ol>
                            <li>Connectez-vous au back-office de votre boutique PrestaShop</li>
                            <li>Allez dans <strong>Paramètres Avancés → Webservice</strong></li>
                            <li>Activez le Webservice si ce n'est pas déjà fait</li>
                            <li>Cliquez sur <strong>"Ajouter une nouvelle clé"</strong></li>
                            <li>Générez une clé et donnez-lui un nom (ex: "Order Manager Integration")</li>
                            <li>Configurez les permissions: <strong>Cochez au minimum les cases pour "orders", "products", "customers", "addresses"</strong></li>
                            <li>Enregistrez et copiez la clé générée dans le champ ci-dessus</li>
                        </ol>
                    </div>
                    ...
                    <div class="integration-info-box">
                        ...
                        <ul>
                            <li><strong>Multi-boutiques :</strong> Vous pouvez connecter plusieurs boutiques PrestaShop</li>
...
<script>
    ...
    function testConnection() {
        const storeUrl = document.getElementById('shop_url').value;
            ...
            if (data.success) {
                ...
                if (data.store_info) {
                    ...
                    if (data.store_info.version) {
                        message += `<br><strong>Version PrestaShop:</strong> ${data.store_info.version}`;
                    }
                }
    ...
    function refreshStats() {
        fetch('{{ route("admin.prestashop.stats") }}')
        .then(response => response.json())
        .then(data => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const urlInput = document.getElementById('shop_url');
        ...
        const form = document.getElementById('prestashop-form');
